...
import app.usbuitest.driver.ACTION
import app.usbuitest.driver.ACTION_EXECUTE
import app.usbuitest.driver.ARGUMENTS
import app.usbuitest.driver.ASSERT_CONTAINS
import app.usbuitest.driver.ASSERT_ENDS_WITH
import app.usbuitest.driver.ASSERT_IS_CHECKED
import app.usbuitest.driver.ASSERT_IS_NOT_CHECKED
import app.usbuitest.driver.ASSERT_STARTS_WITH
import app.usbuitest.driver.ASSERT_TEXT_VALUE
import app.usbuitest.driver.data.DeviceCache.context
import app.usbuitest.driver.data.DeviceCache.getScreenHeight
import app.usbuitest.driver.data.DeviceCache.getScreenWidth
import app.usbuitest.driver.data.DeviceCache.uiAutomation
import app.usbuitest.driver.data.DeviceCache.uiDevice
import app.usbuitest.driver.BACK_BUTTON_CLICK
import app.usbuitest.driver.CAPTURED_TEXT
import app.usbuitest.driver.CAPTURE_TEXT
import app.usbuitest.driver.CMD
import app.usbuitest.driver.CODE
import app.usbuitest.driver.ENTER_TEXT
import app.usbuitest.driver.FAILED_REASON
import app.usbuitest.driver.FPS_24
import app.usbuitest.driver.GO_TO_HOME_SCREEN
import app.usbuitest.driver.HORIZONTAL_SCROLL
import app.usbuitest.driver.IS_DEVICE_ACTION
import app.usbuitest.driver.LAUNCH_APP
import app.usbuitest.driver.NODE_BOUNDS
import app.usbuitest.driver.NODE_IDENTIFIER
import app.usbuitest.driver.PACKAGE_NAME
import app.usbuitest.driver.REQUEST_ID
import app.usbuitest.driver.RESPONSE
import app.usbuitest.driver.ROTATE
import app.usbuitest.driver.ROTATE_LEFT
import app.usbuitest.driver.ROTATE_RIGHT
import app.usbuitest.driver.ROTATE_TO_PORTRAIT
import app.usbuitest.driver.SCREENSHOT
import app.usbuitest.driver.SCREEN_CLICK_INFO
import app.usbuitest.driver.SCREEN_HEIGHT
import app.usbuitest.driver.SCREEN_WIDTH
import app.usbuitest.driver.SCROLL_DOWN
import app.usbuitest.driver.SCROLL_LEFT
import app.usbuitest.driver.SCROLL_RIGHT
import app.usbuitest.driver.SCROLL_UP
import app.usbuitest.driver.SELECT_APP
import app.usbuitest.driver.START_STREAMING
import app.usbuitest.driver.STEP_ID
import app.usbuitest.driver.STOP_EXECUTION
import app.usbuitest.driver.STOP_STREAMING
import app.usbuitest.driver.SUCCESS
import app.usbuitest.driver.SWITCH_TO_PRIMARY_APP
import app.usbuitest.driver.TEST_EXEC_ID
import app.usbuitest.driver.TEST_ID
import app.usbuitest.driver.VALIDATE_ELEMENT
import app.usbuitest.driver.VALIDATE_TEXT
import app.usbuitest.driver.VARIABLE_NAME
import app.usbuitest.driver.VERTICAL_SCROLL
import app.usbuitest.driver.data.Action.Companion.GET_SCREENSHOT_AND_HIERARCHY
import app.usbuitest.driver.data.NodeIdentifier
import app.usbuitest.driver.data.hierarchy.AccNode
import app.usbuitest.driver.data.hierarchy.AccessibilityStreamer
import app.usbuitest.driver.debugLog
import app.usbuitest.driver.listener.FrAccessibilityListener
import app.usbuitest.driver.toMap
import app.usbuitest.driver.data.Data
import app.usbuitest.driver.data.ScreenshotData
import app.usbuitest.driver.data.SingleArgument
...
//                }
                ...
                LAUNCH_APP -> {
                    ...
                    try {
                        ...
                        val appLaunchRes = DeviceActions.launchApp(
                            packageName,
                            argumentMap as Map<String, SingleArgument?>?
                        )
                        val executeResponse = getExecuteResponse(
                            action = LAUNCH_APP,
                            request = json,
