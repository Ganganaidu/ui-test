...
import app.usbuitest.driver.NAME
import app.usbuitest.driver.PACKAGE_NAME
import app.usbuitest.driver.data.DeviceCache
...
import app.usbuitest.driver.VERSION
...
object DeviceActions {
    ...
    private const val UI_RUN_ANDROID = "app.usbuitest.driver"
    private const val UI_RUN_ANDROID_TEST = "app.usbuitest.driver.test"
    ...
    fun getAppList(context: Context): JSONArray {
        ...
        for (resolveInfo in apps) {
            ...
            if (pkgName == UI_RUN_ANDROID || pkgName == UI_RUN_ANDROID_TEST) continue
...
//        return base64String
    ...
    fun enterText(text: String, shouldClearText: Boolean = false, eraseCount: Int = 0) {
