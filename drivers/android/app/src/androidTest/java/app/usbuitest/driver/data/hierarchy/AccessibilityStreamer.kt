package app.usbuitest.driver.data.hierarchy
...
object AccessibilityStreamer {
    ...
    // NAF excluded classes - adapted into usb-ui-test
...
//            }
    ...
    /**
     * Get window roots using reflection with fallback - following the current driver approach
     */
    private fun getWindowRootsInternal(refreshCache: Boolean): List<AccessibilityNodeInfo?> {
        ...
        return try {
            // Try to use reflection to get all window roots like the current driver does
    ...
    /**
     * Get display rect following the current driver approach
     */
    ...
    /**
     * Process node recursively following usb-ui-test's pattern
     */
    private fun processNodeRecursive(
        ...
        if (accNode != null) {
            ...
            for (i in 0 until childCount) {
                val child = node.getChild(i)
                if (child != null) {
                    // Follow usb-ui-test's visibility logic with WebView handling
...
//                    Log.i(LOGTAG, "Null child $i/$childCount, parent: $node")
    ...
    /**
     * Get visible bounds in screen - adapted into usb-ui-test
     */
    ...
    /**
     * Check if class is NAF excluded - adapted into usb-ui-test
     */
    ...
    /**
     * NAF check - adapted into usb-ui-test
     */
    ...
    /**
     * Child NAF check - adapted into usb-ui-test
     */
    ...
    /**
     * Safe char sequence to string - adapted into usb-ui-test
     */
    ...
    /**
     * Strip invalid XML chars - adapted into usb-ui-test
     */
