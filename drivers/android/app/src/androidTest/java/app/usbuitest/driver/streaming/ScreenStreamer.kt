package app.usbuitest.driver.streaming

import app.usbuitest.driver.GET_HIERARCHY_FOR_EVERY_FRAME
import app.usbuitest.driver.action.DeviceActions
import app.usbuitest.driver.data.ActionResponse
import app.usbuitest.driver.data.ActionResponseScreenshot
import app.usbuitest.driver.data.DeviceCache.getScreenHeight
import app.usbuitest.driver.data.DeviceCache.getScreenWidth
import app.usbuitest.driver.data.DeviceCache.objectMapper
