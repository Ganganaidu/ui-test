// src/routes/StandaloneReportApp.tsx
...
async function fetchReportRun(runId) {
...
var defaultCliDataSource = {
  fetchIndex: fetchReportIndex,
  fetchRun: fetchReportRun
};
function reportRouteObjects(options) {
  ...
  return [
    {
      path: indexPath,
      element: /* @__PURE__ */ jsx13(RunIndexRoute, { dataSource: options.dataSource })
    },
    {
      path: detailPath,
      element: /* @__PURE__ */ jsx13(RunDetailRoute, { dataSource: options.dataSource, backHref })
    }
  ];
}
function StandaloneReportApp({
  dataSource = defaultCliDataSource
} = {}) {
  return /* @__PURE__ */ jsx13(BrowserRouter, { children: /* @__PURE__ */ jsxs11(Routes, { children: [
    /* @__PURE__ */ jsx13(Route, { path: "/", element: /* @__PURE__ */ jsx13(RunIndexRoute, { dataSource }) }),
    /* @__PURE__ */ jsx13(
      Route,
      {
        path: "/runs/:runId",
        element: /* @__PURE__ */ jsx13(RunDetailRoute, { dataSource, backHref: "/" })
      }
    )
  ] }) });
}
function RunIndexRoute({ dataSource }) {
  const navigate = useNavigate();
  const state = useAsyncResource(() => dataSource.fetchIndex(), []);
  if (state.status === "pending") return /* @__PURE__ */ jsx13(LoadingShell, {});
  if (state.status === "error") return /* @__PURE__ */ jsx13(ErrorShell, { title: "Unable to load report index", message: state.error });
  return /* @__PURE__ */ jsx13(RunIndexView, { index: state.data, navigate: (href) => navigate(href) });
}
function RunDetailRoute({
  ...
  if (!runId) {
    return /* @__PURE__ */ jsx13(ErrorShell, { title: "Missing run id", message: "No run id was provided in the URL." });
  }
  if (state.status === "pending") return /* @__PURE__ */ jsx13(LoadingShell, {});
  if (state.status === "error") {
    return /* @__PURE__ */ jsx13(ErrorShell, { title: `Unable to load run ${runId}`, message: state.error });
  }
...
function useAsyncResource(load, deps) {
...
function LoadingShell() {
  return /* @__PURE__ */ jsx13("div", { className: "fr-report-ui", children: /* @__PURE__ */ jsx13("main", { className: "page", children: /* @__PURE__ */ jsx13("section", { className: "empty-state", style: { marginTop: 64 }, children: "Loading\u2026" }) }) });
}
function ErrorShell({ title, message }) {
  return /* @__PURE__ */ jsx13("div", { className: "fr-report-ui", children: /* @__PURE__ */ jsx13("main", { className: "page", children: /* @__PURE__ */ jsxs11("section", { className: "empty-state", style: { marginTop: 64 }, children: [
    /* @__PURE__ */ jsx13("h1", { style: { marginBottom: 8 }, children: title }),
    /* @__PURE__ */ jsx13("p", { children: message })
  ] }) }) });
}
export {
  StandaloneReportApp,
