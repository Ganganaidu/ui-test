...
// <BrowserRouter>. Other host apps can instead spread reportRouteObjects()
// into their own data router, which is why the route config is exported as
// plain RouteObject[] without a router wrapper.
...
// parent `createBrowserRouter([...])` config. Default paths match the
// CLI-hosted SPA; host apps can pass overrides for their own route structure.
