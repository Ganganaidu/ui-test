// Public library entry point. Imported from consumers embedding the report UI
// via `@usb-ui-test/report-web/ui`.
//
// Stable surface:
...
//   - Data-model types re-exported from @usb-ui-test/common + artifacts
//
// NOTE: consumers MUST also import the companion stylesheet:
//   import '@usb-ui-test/report-web/ui/styles.css';
