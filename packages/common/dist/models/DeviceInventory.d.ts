...
export type DeviceInventoryDiagnosticScope = 'android-connected' | 'android-targets' | 'ios-simulators' | 'startup';
...
export type DeviceInventoryTargetKind = 'android-device' | 'android-emulator' | 'ios-simulator';
export type DeviceInventoryState = 'connected' | 'booted' | 'shutdown' | 'offline' | 'unauthorized' | 'unavailable';
...
//# sourceMappingURL=DeviceInventory.d.ts.map